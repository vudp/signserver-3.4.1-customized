 ...
 * @version $Id: OOXMLSigner.java 2841 2012-10-16 08:31:40Z netmackan $
...
public class OOXMLSigner extends BaseSigner {
    ...
    private String WORKERNAME = "OOXMLSigner";
    ...
    public ProcessResponse processData(ProcessRequest signRequest,
        ...
        try {
        	...
        	return new GenericSignResponse(sReq.getRequestID(), archiveId, Defines.CODE_OOXMLFORMAT, Defines.ERROR_OOXMLFORMAT);

            //throw new SignServerException("Data received is not in valid openxml package format", e);

        } catch (IOException e) {

        	return new GenericSignResponse(sReq.getRequestID(), archiveId, Defines.CODE_OOXMLOPENFILE, Defines.ERROR_OOXMLOPENFILE);
        ...
        try {
        	...
        	return new GenericSignResponse(sReq.getRequestID(), archiveId, Defines.CODE_OOXMLSIGNPROBLEM, Defines.ERROR_OOXMLSIGNPROBLEM);
        ...
        try {
        	...
        	return new GenericSignResponse(sReq.getRequestID(), archiveId, Defines.CODE_ODFSAVESTREAM, Defines.ERROR_ODFSAVESTREAM);

            //throw new SignServerException("Error saving final output data to output", e);
        ...
        if (signRequest instanceof GenericServletRequest) {
            ...
            signResponse = new GenericSignResponse(sReq.getRequestID(),
                    ...
                    signedbytes, getSigningCertificate(), null, archiveId, archivables, ResponseCode, ResponseMessage);
