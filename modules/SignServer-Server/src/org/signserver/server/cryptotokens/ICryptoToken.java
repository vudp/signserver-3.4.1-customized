 ...
 * @version $Id: ICryptoToken.java 2966 2012-11-09 10:30:48Z netmackan $
 */
public interface ICryptoToken {
     ...
     */
    boolean destroyKey(int purpose, String authCode, String alias);
    ...
    TElX509Certificate getTElX509Certificate();
}
