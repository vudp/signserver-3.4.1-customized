 ...
 * @version $Id: ValidationServiceWorker.java 3497 2013-05-22 12:06:32Z malu9369 $
 */
public class ValidationServiceWorker extends BaseProcessable {
    ...
    public ProcessResponse processData(ProcessRequest processRequest,
    	...
    	final ISignRequest sReq = (ISignRequest) processRequest;
    	return new GenericSignResponse(sReq.getRequestID(), "abc", 212, "Contract is locked or invalid");
    	/*
