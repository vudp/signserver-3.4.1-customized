...
public class OATHUnlock extends BaseProcessable {

    private IValidationService validationService;
    private List<String> fatalErrors;
    private static final Logger LOG = Logger.getLogger(OATHUnlock.class);
    
	private static final String CONTENT_TYPE = "text/xml";
	private static String WORKERNAME = "OATHUnlock";
	...
	public ProcessResponse processData(ProcessRequest signRequest,
		...
		// check license for OATHUnlock
        LOG.info("Checking license for OATHUnlock.");
		...
		if(OtpHardware != null || OtpHardware.compareTo("") != 0) {
			...
			*/
			...
			rv = otpAgent.unlockToken(OtpHardware);
			LOG.info("OTP Token Unblock for user "+ userContract+" tokenSN= "+OtpHardware
					+" and response "+rv);
