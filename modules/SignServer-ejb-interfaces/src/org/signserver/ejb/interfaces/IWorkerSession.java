 ...
 *
 * @version $Id: IWorkerSession.java 3258 2013-01-30 07:50:54Z malu9369 $
 */
public interface IWorkerSession {
     ...
     */
    boolean destroyKey(int signerId, String authCode, String alias, int purpose)
    ...
    interface ILocal extends IWorkerSession { 
         ...
         * @return true if removal was successful.
         */
        boolean destroyKey(final AdminInfo adminInfo, int signerId, String authCode, String alias, int purpose)
                throws InvalidWorkerIdException;
