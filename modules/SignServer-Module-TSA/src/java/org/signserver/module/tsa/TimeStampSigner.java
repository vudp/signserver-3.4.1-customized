 ...
 *
 * <table border="1"> <tr> <td>TIMESOURCE</td> <td> property containing the
 * classpath to the ITimeSource implementation that should be used. (default
 * LocalComputerTimeSource) </td> </tr> <tr> <td>ACCEPTEDALGORITHMS</td> <td> A
 * ';' separated string containing accepted algorithms, can be null if it
 * shouldn't be used. (OPTIONAL) </td> </tr> <tr> <td>ACCEPTEDPOLICIES</td> <td>
 * A ';' separated string containing accepted policies, can be null if it
 * shouldn't be used. (OPTIONAL) </td> </tr> <tr> <td>ACCEPTEDEXTENSIONS</td>
 * <td> A ';' separated string containing accepted extensions, can be null if it
 * shouldn't be used. (OPTIONAL) </td> </tr> <tr> <td>DIGESTOID</td> <td> The
 * Digenst OID to be used in the timestamp </td> </tr> <tr>
 * <td>DEFAULTTSAPOLICYOID</td> <td> The default policy ID of the time stamp
 * authority </td> </tr> <tr> <td>ACCURACYMICROS</td> <td> Accuraty in micro
 * seconds, Only decimal number format, only one of the accuracy properties
 * should be set (OPTIONAL) </td> </tr> <tr> <td>ACCURACYMILLIS</td> <td>
 * Accuraty in milli seconds, Only decimal number format, only one of the
 * accuracy properties should be set (OPTIONAL) </td> </tr> <tr>
 * <td>ACCURACYSECONDS</td> <td> Accuraty in seconds. Only decimal number
 * format, only one of the accuracy properties should be set (OPTIONAL) </td>
 * </tr> <tr> <td>ORDERING</td> <td> The ordering (OPTIONAL), default false.
 * </td> </tr> <tr> <td>TSA</td> <td> General name of the Time Stamp Authority.
 * </td> </tr> <tr> <td>REQUIREVALIDCHAIN</td> <td> Set to true to perform an
 * extra check that the SIGNERCERTCHAIN only contains certificates in the chain
 * of the signer certificate. (OPTIONAL), default false. </td> </tr>
 *
 * </table>
 *
 * Specifying a signer certificate (normally the SIGNERCERT property) is
 * required as information from that certificate will be used to indicate which
 * signer signed the time-stamp token.
 *
 ...
 *
 * @author philip
 * @version $Id: TimeStampSigner.java 3459 2013-04-25 13:03:11Z malu9369 $
 */
public class TimeStampSigner extends BaseSigner {
    ...
    private String WORKERNAME = "TimeStampSigner";
    ...
    public void init(final int signerId, final WorkerConfig config,
        ...
        /*
         * defaultDigestOID =
         * config.getProperties().getProperty(DEFAULTDIGESTOID); if
         * (defaultDigestOID == null) { defaultDigestOID = DEFAULT_DIGESTOID;
        }
         */
    ...
    /**
     * The main method performing the actual timestamp operation. Expects the
     * signRequest to be a GenericSignRequest contining a TimeStampRequest
     *
     * @param signRequest
     * @param requestContext
     * @return the sign response
     * @see
     * org.signserver.server.IProcessable#processData(org.signserver.common.ProcessRequest,
    ...
    /**
     * Help method taking a string and creating a java.util.Set of the strings
     * using ';' as a delimiter. If null is used as and argument then will null
    ...
    private TimeStampTokenGenerator getTimeStampTokenGenerator(
        ...
        try {
            ...
            /*
             * if (digestOID == null) { digestOID = defaultDigestOID;
            }
             */
            ...
            final X509Certificate signingCert = (X509Certificate) getSigningCertificate();
            if (signingCert == null) {
    ...
    /**
     * Help method that generates a serial number using SecureRandom. Uses the
     * configured length of the signer. This is public to allow using directly
     * from unit test.
     */
     ...
     * a positive number.
     *
     * @param maxLength the maximum number of octects of the generated serial
     * number
    ...
    /**
     * Get serial number error We run this stand-alone from the unit test
     *
     */
