/**
 * This file is originally from BouncyCastle 1.47 and modified to allow to leave
 * out the status string in the timestamp response. This is as a work-around for
 * a bug in OpenJDK's jarsigner utility.
 *
 * @see <a href="https://jira.primekey.se/browse/DSS-378">Issue in
 * SignServer</a>
 * @see <a href="http://www.bouncycastle.org/jira/browse/BJA-433">Issue in
 * BC</a>
 *
 * This will be fixed in BC 1.49. Also newer versions of OpenJDK will not have
 * this bug.
 *
 */
...
public class TimeStampResponseGenerator {
     ...
     * @param tokenGenerator
     * @param acceptedAlgorithms a set of OIDs giving accepted algorithms.
     * @param acceptedPolicies if non-null a set of policies OIDs we are willing
     * to sign under.
     */
    public TimeStampResponseGenerator(
            TimeStampTokenGenerator tokenGenerator,
     ...
     * @param acceptedPolicies if non-null a set of policies OIDs we are willing
     * to sign under.
     * @param acceptedExtensions if non-null a set of extensions OIDs we are
     * willing to accept.
     */
    public TimeStampResponseGenerator(
            TimeStampTokenGenerator tokenGenerator,
    ...
    /**
     * Return an appropriate TimeStampResponse. <p> If genTime is null a
     * timeNotAvailable error response will be returned.
     *
     ...
     * @return a TimeStampResponse with a failInfoField and optional
     * statusString
