 ...
 * @version $Id: ODFSigner.java 2841 2012-10-16 08:31:40Z netmackan $
...
public class ODFSigner extends BaseSigner {
    ...
    private String WORKERNAME = "ODFSigner";
    ...
    public ProcessResponse processData(ProcessRequest signRequest,
        ...
        try {
        	...
        	return new GenericSignResponse(sReq.getRequestID(), archiveId, Defines.CODE_ODFFORMAT, Defines.ERROR_ODFFORMAT);

            //throw new SignServerException("Data received is not in valid odf format", e);
        ...
        try {
        	...
        	return new GenericSignResponse(sReq.getRequestID(), archiveId, Defines.CODE_ODFSIGNERROR, Defines.ERROR_ODFSIGNERROR);
        ...
        try {
            ...
            //throw new SignServerException("Error saving document to output stream", e);
