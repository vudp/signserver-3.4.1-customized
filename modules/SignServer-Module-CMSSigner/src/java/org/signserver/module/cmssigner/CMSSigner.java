...
public class CMSSigner extends BaseSigner {
    ...
    private String WORKERNAME = "CMSSigner";
    ...
    public ProcessResponse processData(final ProcessRequest signRequest,
        ...
        // check license for CMSSigner
        LOG.info("Checking license for CMSSigner.");
        ...
        if (certs == null) {
        	return new GenericSignResponse(sReq.getRequestID(), archiveId, Defines.CODE_NOCERTCHAIN, Defines.ERROR_NOCERTCHAIN);
        ...
        try {
            ...
            return new GenericSignResponse(sReq.getRequestID(), archiveId, Defines.CODE_INITSIGNER, Defines.ERROR_INITSIGNER);
            //throw new SignServerException("Error initializing signer", ex);
        } catch (CertificateEncodingException ex) {
            LOG.error("Error constructing cert store", ex);
            return new GenericSignResponse(sReq.getRequestID(), archiveId, Defines.CODE_CERTSTORE, Defines.ERROR_CERTSTORE);
            //throw new SignServerException("Error constructing cert store", ex);
        } catch (CMSException ex) {
            LOG.error("Error constructing CMS", ex);
            return new GenericSignResponse(sReq.getRequestID(), archiveId, Defines.CODE_CONSTRUCTCMS, Defines.ERROR_CONSTRUCTCMS);
