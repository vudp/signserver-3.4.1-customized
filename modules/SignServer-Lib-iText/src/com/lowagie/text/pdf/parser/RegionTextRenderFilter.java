...
import com.lowagie.awt.geom.Rectangle;
...
public class RegionTextRenderFilter extends RenderFilter {
    ...
    /**
     * Constructs a filter
     * @param filterRect the rectangle to filter text against.  Note that this is a com.lowagie.text.geom.Rectangle !
     */
    ...
    /** 
     * @see com.lowagie.text.pdf.parser.RenderFilter#allowText(com.lowagie.text.pdf.parser.TextRenderInfo)
     */
