...
import com.lowagie.text.pdf.security.LtvVerification.CertificateOption;
...
public class LtvVerifier extends RootStoreVerifier {
	 ...
	 * @throws GeneralSecurityException
	 * @throws IOException
	 * @see com.lowagie.text.pdf.security.RootStoreVerifier#verify(java.security.cert.X509Certificate, java.security.cert.X509Certificate)
	 */
