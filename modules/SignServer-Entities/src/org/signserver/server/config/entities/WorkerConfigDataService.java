...
public class WorkerConfigDataService implements IWorkerConfigDataService {
        ...
        if (wcdb != null) {
            ...
            try {
                decoder =
                        ...
                        new java.io.ByteArrayInputStream(wcdb.getSignerConfigData().getBytes("UTF-8")));
    ...
    private void setWorkerConfig(int workerId, WorkerConfig signconf, WorkerConfigDataBean wcdb) {
        ...
        try {
            ...
            wcdb.setSignerConfigData(baos.toString("UTF-8"));
	//System.out.println("[WorkerConfigDataService] baos: "+baos.toString("UTF-8"));
            em.persist(wcdb);
        } catch (UnsupportedEncodingException e) {
            throw new EJBException(e);
        }
