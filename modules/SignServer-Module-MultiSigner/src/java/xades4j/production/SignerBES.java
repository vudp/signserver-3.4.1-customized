...
class SignerBES implements XadesSigner
{
    ...
    public final XadesSignatureResult sign(
            ...
            Node parent, String signatureId, boolean includeSubjectName) throws XAdES4jException
    {
        return sign(signedDataObjects, parent, SignatureAppendingStrategies.AsLastChild, signatureId, includeSubjectName);
    }
    ...
    public final XadesSignatureResult sign(
            SignedDataObjects signedDataObjects,
            Node referenceNode,
            SignatureAppendingStrategy appendingStrategy, String signatureId, boolean includeSubjectName) throws XAdES4jException
    {
    	...
    	//String signatureId = String.format("SigId-%s", UUID.randomUUID());
        if(signatureId == null) {
        	// Generate unique identifiers for the Signature and the SignedProperties.
        	signatureId = String.format("SigId-%s", UUID.randomUUID());
        }
        String signedPropsId = String.format("%s-SignedProperties", signatureId);
        ...
        /* ds:KeyInfo */
        this.keyInfoBuilder.buildKeyInfo(signingCertificate, signature, includeSubjectName);
        ...
        try
        {
            ...
            DOMHelper.setIdAsXmlId(sigValueElem, String.format("%s-SignatureValue", signatureId));
	...
	@Override
	public XadesSignatureResult sign(SignedDataObjects signedDataObjects,
			Node parent, String signatureLocation, String signatureId, boolean includeSubjectName) throws XAdES4jException {
		// TODO Auto-generated method stub
		return sign(signedDataObjects, parent, SignatureAppendingStrategies.getAppendAsCertainNodeStrategy(signatureLocation), signatureId, includeSubjectName);
	}
}
