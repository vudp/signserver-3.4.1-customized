...
public class Enveloped
{
     ...
     */
    public void sign(Element elementToSign, String signatureId) throws XAdES4jException
    {
        String refUri;
        ...
        signer.sign(new SignedDataObjects(dataObjRef), elementToSign, signatureId, true);
    }
    
    public void sign(Element elementToSign, String signatureLocation, String signatureId, boolean includeSubjectName) throws XAdES4jException
    {
        String refUri;
        if (elementToSign.hasAttribute("Id"))
            refUri = '#' + elementToSign.getAttribute("Id");
        ...
        DataObjectDesc dataObjRef = new DataObjectReference(refUri).withTransform(new EnvelopedSignatureTransform());
        signer.sign(new SignedDataObjects(dataObjRef), elementToSign, signatureLocation, signatureId, includeSubjectName);
    }
}
