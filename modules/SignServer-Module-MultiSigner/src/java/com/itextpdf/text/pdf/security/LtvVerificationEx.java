...
import com.itextpdf.text.pdf.PdfStamperEx;
 ...
 * @author Paulo Soares
 */
public class LtvVerificationEx {

    private Logger LOGGER = LoggerFactory.getLogger(LtvVerificationEx.class);

    private PdfStamperEx stp;
     ...
     */
    public LtvVerificationEx(PdfStamperEx stp) {
        this.stp = stp;
