...
public class PdfPKCS7_v4 {
     ...
     */
    public PdfPKCS7_v4(PrivateKey privKey, Certificate[] certChain, 
	...
	public PdfPKCS7_v4(byte[] contentsKey, byte[] certsKey, String provider) {
        try {
            this.provider = provider;
     ...
     */
	@SuppressWarnings({ "unchecked" })
	public PdfPKCS7_v4(byte[] contentsKey, PdfName filterSubtype, String provider) {
