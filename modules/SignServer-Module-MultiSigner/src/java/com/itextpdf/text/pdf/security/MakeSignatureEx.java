...
import com.itextpdf.text.pdf.PdfSignatureAppearanceEx;
 ...
 * @author Paulo Soares
 */
public class MakeSignatureEx {

	/** The Logger instance. */
    private static final Logger LOGGER = LoggerFactory.getLogger(MakeSignatureEx.class);
     ...
     */
    public static void signDetached(PdfSignatureAppearanceEx sap, ExternalDigest externalDigest, ExternalSignature externalSignature, Certificate[] chain, Collection<CrlClient> crlList, OcspClient ocspClient,
     ...
     */
    public static void signDetached(PdfSignatureAppearanceEx sap, ExternalDigest externalDigest, ExternalSignature externalSignature, Certificate[] chain, Collection<CrlClient> crlList, OcspClient ocspClient,
                                    TSAClient tsaClient, int estimatedSize, MakeSignature.CryptoStandard sigtype, SignaturePolicyInfo signaturePolicy) throws IOException, DocumentException, GeneralSecurityException {
     ...
     * @throws DocumentException 
     */
    public static void signExternalContainer(PdfSignatureAppearanceEx sap, ExternalSignatureContainer externalSignatureContainer, int estimatedSize) throws GeneralSecurityException, IOException, DocumentException {
