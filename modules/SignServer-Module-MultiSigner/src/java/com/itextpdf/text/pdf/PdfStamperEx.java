...
import com.itextpdf.text.pdf.security.LtvVerificationEx;
...
public class PdfStamperEx
    ...
    protected PdfSignatureAppearanceEx sigApp;
    private LtvVerificationEx verification;
     ...
     */
    public PdfStamperEx(final PdfReader reader, final OutputStream os) throws DocumentException, IOException {
     ...
     * @throws IOException on error
     */
    public PdfStamperEx(final PdfReader reader, final OutputStream os, final char pdfVersion) throws DocumentException, IOException {
     ...
     * @throws IOException on error
     */
    public PdfStamperEx(final PdfReader reader, final OutputStream os, final char pdfVersion, final boolean append) throws DocumentException, IOException {
     ...
     */
    public PdfSignatureAppearanceEx getSignatureAppearance() {
        return sigApp;
    }
     ...
     * @throws IOException on error
     */
    public static PdfStamperEx createSignature(final PdfReader reader, final OutputStream os, final char pdfVersion, File tempFile, final boolean append) throws DocumentException, IOException {
        PdfStamperEx stp;
        if (tempFile == null) {
            ByteBuffer bout = new ByteBuffer();
            stp = new PdfStamperEx(reader, bout, pdfVersion, append);
            stp.sigApp = new PdfSignatureAppearanceEx(stp.stamper);
            ...
            stp = new PdfStamperEx(reader, fout, pdfVersion, append);
            stp.sigApp = new PdfSignatureAppearanceEx(stp.stamper);
     ...
     * @return a <CODE>PdfStamper</CODE>
     */
    public static PdfStamperEx createSignature(final PdfReader reader, final OutputStream os, final char pdfVersion) throws DocumentException, IOException {
     ...
     * @throws IOException on error
     */
    public static PdfStamperEx createSignature(final PdfReader reader, final OutputStream os, final char pdfVersion, final File tempFile) throws DocumentException, IOException {
    ...
    public LtvVerificationEx getLtvVerification() {
        if (verification == null)
            verification = new LtvVerificationEx(this);
        return verification;
    }
