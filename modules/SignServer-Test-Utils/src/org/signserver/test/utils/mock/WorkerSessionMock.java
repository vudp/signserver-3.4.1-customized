 ...
 *
 * @author Markus Kilås
 * $version $Id: WorkerSessionMock.java 3452 2013-04-20 21:32:59Z netmackan $
 */
public class WorkerSessionMock implements IWorkerSession.ILocal,
    ...
    @Override
    public boolean destroyKey(int signerId, String authCode, String alias, int purpose) throws
            InvalidWorkerIdException {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    
    @Override
    public boolean destroyKey(final AdminInfo adminInfo, int signerId, String authCode, String alias, int purpose) throws
        InvalidWorkerIdException {
        throw new UnsupportedOperationException("Not supported yet.");
    }
