 ...
 * @version $Id: SignerStatus.java 2615 2012-09-07 08:02:43Z netmackan $
 */
	...
	public void displayStatus(int workerId, PrintStream out, boolean complete) {
		...
		if(complete){
			...
			while(propertyKeys.hasMoreElements()){
				...
				//System.out.println("[SignerStatus] Content of key: "+getActiveSignerConfig().getProperties().getProperty(key));
			}        		
