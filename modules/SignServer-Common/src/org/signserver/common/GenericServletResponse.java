...
public class GenericServletResponse extends GenericSignResponse {
    ...
    public GenericServletResponse(int requestID, byte[] processedData,
            ...
            String contentType) {
        super(requestID, processedData, signerCertificate, null, archiveId, archivables);
    ...
    public GenericServletResponse(int requestID, byte[] processedData,
            ...
            String contentType) {
        super(requestID, processedData, signerCertificate, null, archiveId, archivables, responseCode, responseMessage);
        this.contentType = contentType;
    }
    
    public GenericServletResponse(int requestID, String archiveId, int responseCode, String responseMessage, String contentType) {
        super(requestID, archiveId, responseCode, responseMessage);
        this.contentType = contentType;
    }
