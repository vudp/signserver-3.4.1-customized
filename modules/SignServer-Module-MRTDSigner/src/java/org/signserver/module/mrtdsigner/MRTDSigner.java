 ...
 * @version $Id: MRTDSigner.java 2859 2012-10-22 09:13:23Z malu9369 $
 */
    ...
    public ProcessResponse processData(ProcessRequest signRequest,
        ...
        if (signRequest instanceof MRTDSignRequest) {
            ...
            if (signRequest instanceof GenericServletRequest) {
                ...
                ret = new GenericSignResponse(sReq.getRequestID(), signedbytes, getSigningCertificate(), null, archiveId, archivables);
            }
        } else {
