 ...
 * 
 * @version $Id: WorkerSessionBean.java 3452 2013-04-20 21:32:59Z netmackan $
 */
@Stateless
public class WorkerSessionBean implements IWorkerSession.ILocal,
     ...
     */
    @Override
    public boolean destroyKey(int signerId, String authCode, String alias, int purpose) throws InvalidWorkerIdException {
        return destroyKey(new AdminInfo("CLI user", null, null), signerId, authCode, alias, purpose);
    }

    @Override
    public boolean destroyKey(AdminInfo adminInfo, int signerId, String authCode, String alias, int purpose)
        ...
        return signer.destroyKey(purpose, authCode, alias);
    }
    ...
    public void uploadSignerCertificate(final AdminInfo adminInfo, int signerId, byte[] signerCert,
        ...
        X509Certificate test = (X509Certificate)cert;
    ...
    public int genFreeWorkerId() {
        ...
        return max + 1;
        */
        return DBConnector.getInstances().getWorkerUUID();
    }
